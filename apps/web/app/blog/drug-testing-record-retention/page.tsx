...
export default function Page() {
    return (
        <BlogPostLayout category="Drug & Alcohol Testing" title="Drug & Alcohol Record Retention: A Cheat Sheet" date="February 5, 2026" readTime="4 min read" relatedPosts={[{ slug: "drug-alcohol-testing-compliance", title: "Drug & Alcohol Testing Guide" }, { slug: "dot-audit-document-checklist", title: "DOT Audit Document Checklist" }]}>
            ...
            <p>Here&apos;s the breakdown under <strong>§382.401</strong>.</p>

            <h2>5-Year Retention</h2>
            <ul>
                <li>Positive drug test results (verified by MRO)</li>
                <li>Alcohol test results of 0.02 BAC or greater</li>
                <li>Refusals to test</li>
                <li>SAP evaluations and follow-up testing records</li>
            ...
            <ul>
                ...
                <li>Calibration documentation for Evidential Breath Testing devices</li>
            </ul>
            ...
            <h2>Storage Tips</h2>
            <p>Keep drug/alcohol records <strong>separate from general personnel files</strong>. Access should be limited to the DER and individuals with a legitimate need to know. These records contain sensitive medical information.</p>
