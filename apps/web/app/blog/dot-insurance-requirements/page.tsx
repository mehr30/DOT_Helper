...
export default function Page() {
    return (
        <BlogPostLayout category="Regulations" title="DOT Insurance Requirements: What You Need, What It Costs, and What Happens When It Lapses" date="February 17, 2026" readTime="7 min read" relatedPosts={[{ slug: "fmcsa-compliance-guide", title: "FMCSA Compliance Guide" }, { slug: "fmcsa-operating-authority-guide", title: "FMCSA Operating Authority Guide" }]}>
            ...
            <h2>Minimum Coverage Requirements (Part 387)</h2>
            <ul>
            ...
            <h2>The BMC-91 Filing</h2>
            <p>Your insurance company must file a <strong>Form BMC-91</strong> electronically with FMCSA. This is how the government knows you have active coverage. You can check your filing status at <em>safer.fmcsa.dot.gov</em>.</p>
            ...
            <ol>
                <li>Your insurer files a <strong>BMC-35</strong> (cancellation notice) with FMCSA</li>
