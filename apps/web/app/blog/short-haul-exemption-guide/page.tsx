    ...
    return (
        <BlogPostLayout category="Driver Management" title="The Short-Haul Exemption: Who Qualifies and What It Actually Means" date="February 7, 2026" readTime="6 min read" relatedPosts={[{ slug: "hos-rules-explained", title: "Hours of Service Rules Explained" }, { slug: "eld-compliance-guide", title: "ELD Compliance Guide" }]}>
            <div className={styles.calloutAmber}>
                ...
                <p>The short-haul exemption can apply to both CDL (Commercial Driver&apos;s License) and non-CDL drivers who operate within a limited radius of their home base. If your drivers return to the same location every day and stay within the distance limits, they may qualify for this exemption.</p>
            </div>

            <p>The short-haul exemption is one of the more generous provisions in HOS (Hours of Service &mdash; the federal rules limiting how long a driver can be on duty and behind the wheel) rules — if you qualify. No ELD (Electronic Logging Device &mdash; the federally mandated device that automatically records driving time) required. No daily logs. Just a timecard. But the qualification rules have some gotchas that trip up plenty of carriers.</p>

            <h2>CDL Short-Haul (&sect;395.1(e)(1))</h2>
            <p>CDL drivers qualify if they:</p>
            <ul>
                <li>Operate within a <strong>150 air-mile radius</strong> (air miles are the straight-line distance between two points &mdash; not road miles) of their normal work reporting location</li>
            ...
            <h2>Non-CDL Short-Haul / Timecard Exception (&sect;395.1(e)(2))</h2>
            ...
            <ul>
                ...
                <li><strong>Exceed 14 hours</strong> — the driver must switch to full RODS (Records of Duty Status &mdash; the official log of a driver&apos;s driving and on-duty time) for that day</li>
