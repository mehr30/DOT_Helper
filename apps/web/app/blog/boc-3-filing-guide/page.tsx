    ...
    return (
        <BlogPostLayout category="Compliance" title="BOC-3 Filing: What It Is and Why Your Authority Depends on It" date="February 16, 2026" readTime="5 min read" relatedPosts={[{ slug: "dot-compliance-checklist", title: "The Ultimate DOT Compliance Checklist" }, { slug: "fmcsa-operating-authority-guide", title: "FMCSA Operating Authority Guide" }]}>
            <div className={styles.calloutAmber}>
                ...
                <p>A BOC-3 filing is required for any motor carrier, broker, or freight forwarder that has or is applying for operating authority (MC number) to operate in interstate commerce.</p>
            </div>

            <p>Most carriers know they need a USDOT number and an MC number. But ask them about their <strong>BOC-3 (a form designating process agents — legal representatives authorized to accept legal documents on your behalf — in each state)</strong>? Blank stares. Until their authority gets held up because the filing lapsed.</p>
            ...
            <p>It&apos;s required under <strong>the FMCSA regulation requiring process agent designation (49 CFR Part 366)</strong> before FMCSA will grant you operating authority.</p>

            <h2>How to File</h2>
            <p>You can&apos;t file a BOC-3 yourself. You need a <strong>blanket service provider (a company that serves as your process agent in all states for a single fee)</strong> — a company that has agents in every state. Typical cost: <strong>$30-$75 one-time</strong> through a filing service. Some charge annual renewals of $15-30.</p>
