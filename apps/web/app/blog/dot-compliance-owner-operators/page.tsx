...
export default function Page() {
    return (
        <BlogPostLayout category="Compliance" title="DOT Compliance for Owner-Operators: Running Legal as a One-Person Fleet" date="February 6, 2026" readTime="8 min read" relatedPosts={[{ slug: "dot-compliance-checklist", title: "The Ultimate DOT Compliance Checklist" }, { slug: "usdot-number-requirements", title: "USDOT Number Requirements" }]}>
            ...
            <p><strong>Leased to a carrier:</strong> The carrier you&apos;re leased to is technically responsible for your compliance — your DQF, drug testing, HOS oversight. But if their compliance is garbage, your CDL is still on the line during a roadside inspection. Know your own records.</p>
            ...
            <ul>
                ...
                <li>Current BOC-3 filing</li>
                <li>Insurance (BMC-91 filed with FMCSA)</li>
                <li>UCR registration</li>
                <li>IFTA license (if operating in multiple states)</li>
                ...
                <li>ELD on the truck</li>
                <li>FMCSA Clearinghouse registration (both as employer and driver)</li>
            </ul>

            <h2>The Consortium Situation</h2>
            <p>You can&apos;t run your own random drug testing pool with one person. Well, technically you could, but you&apos;d be tested every single quarter. Instead, join a <strong>consortium</strong> (also called a TPA — Third Party Administrator). They&apos;ll manage your random selections, handle the paperwork, and cost you somewhere around <strong>$75-$150/year</strong>.</p>
